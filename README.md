...
| 首页（专注入口） | 专注模式 | 任务看板 |
| --- | --- | --- |
| ![首页](screenshots/首页.PNG) | ![专注模式](screenshots/专注模式.PNG) | ![任务看板](screenshots/任务看板.PNG) |

| 新建任务 | 日记页面 | 随心记 |
| --- | --- | --- |
| ![新建任务](screenshots/新建任务.PNG) | ![日记页面](screenshots/日记页面.PNG) | ![随心记页面](screenshots/随心记页面.PNG) |

### 📊 数据复盘

| 复盘页面 | 复盘视图 | 总结页面 |
| --- | --- | --- |
| ![复盘页面](screenshots/复盘页面.PNG) | ![复盘视图](screenshots/复盘视图.PNG) | ![总结页面](screenshots/总结页面.PNG) |

| 本周成长 | 日周月时间选择 |
| --- | --- |
| ![本周成长页面](screenshots/本周成长页面.PNG) | ![日周月时间选择](screenshots/日周月时间选择.PNG) |
